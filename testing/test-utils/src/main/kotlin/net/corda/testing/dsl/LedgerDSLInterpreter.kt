...
interface OutputStateLookup {
     ...
     * Returns the output [StateAndRef].
     */
...
interface LedgerDSLInterpreter<out T : TransactionDSLInterpreter> : Verifies, OutputStateLookup {
     ...
     * Returns the final [WireTransaction] of the built transaction.
     */
     ...
     * Returns the [SecureHash] that identifies the attachment, to be used in transactions.
     */
