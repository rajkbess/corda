...
class NodeParametersStorage(
    ...
    // TODO For the future we should get them as signed attachments on transactions.
    ...
    class PersistentNetworkParameters(
        ...
        val signedNetworkParameters: SignedDataWithCert<NetworkParameters>
            get() {
                // TODO What with parent certificate chain (recent certificate hierarchy change - ask Michal).
