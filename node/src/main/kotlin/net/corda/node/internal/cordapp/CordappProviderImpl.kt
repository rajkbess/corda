...
open class CordappProviderImpl(private val cordappLoader: CordappLoader,
     ...
     * Returns an attachment ID if it exists, otherwise nothing.
     */
     ...
     * Returns a cordapp context for the given CorDapp.
     */
     ...
     * Returns a [Cordapp] or null if no cordapp has the given class loaded.
     */
