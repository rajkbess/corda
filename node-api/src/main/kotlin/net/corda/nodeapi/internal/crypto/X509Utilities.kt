...
object X509Utilities {
     ...
     * Returns the [X509Certificate] that was encoded in the file.
     */
    @JvmStatic
     ...
     * @param crlIssuer X500Name of the CRL issuer.
     *
     * Returns a data class is returned containing the new intermediate CA Cert and its [KeyPair] for signing downstream certificates.
