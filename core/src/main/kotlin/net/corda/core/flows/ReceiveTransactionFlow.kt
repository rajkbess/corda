...
open class ReceiveTransactionFlow @JvmOverloads constructor(private val otherSideSession: FlowSession,
    ...
    /**
     * Return the received [SignedTransaction] even if it failed verification or was deemed invalid for any other reason.
     * This is only here for debugging purposes.
     */
    val receivedTransaction: SignedTransaction? get() = _receivedTransaction
